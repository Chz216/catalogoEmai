...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-black">
    ...
    <div id="myNabvar" class="collapse navbar-collapse justify-content-end">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6  col-md-12">
              ...
              <p class="text-justify lead">Nuestra misión es proporcionar los mejores instrumentos
                musicales con la más alta calidad y precios accesibles, para satisfacer a nuestros
                clientes. Queremos que estén satisfechos con nuestros productos y servicios.
                Brindaremos un mejor sonido y diseños innovadores para que tanto niños, jóvenes y
                adultos tengan acceso a productos que estén a la vanguardia.
              </p>
              <BR>
              <h1 class="display-3">VISIÓN</h1>
              <p class="text-justify lead">
                Nuestra visión es ser la empresa número uno en venta de instrumentos musicales, así como
                también lograr un mejor sonido y diseños vanguardistas para lograr una mejor imagen en
                nuestros instrumentos.</p>
            </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 text-center">
            ...
            <p><a href="https://www.facebook.com/tiendaemai"><span class="fa fa-facebook-square mr-2"
                  style='color:white;'></span></a>Facebook</p>
